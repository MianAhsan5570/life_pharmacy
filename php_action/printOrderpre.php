...
if ( mysqli_num_rows($orderItemResult) > 0) {
 ...
 ?>
 	...
 	<div class="" style="width: 100%" align="center">
 				<div class="" style="width: 49%;float: left;text-align: right;"  >
					<h1>Life  Pharmacy </h1>
				</div>
				
				<div class="" style="width: 49%;float: left;text-align: left;"   >
			<h1>		لائف    فارمیسی     </h1>
				</div>
 	</div><br/>
	...
	<thead>
		...
		<tr >
			...
			<div align="center">
				...
				Order Date : <strong><?php echo $orderDate ; ?> - <?=date('h:i a',strtotime($time2)) ?>  </strong><br />
