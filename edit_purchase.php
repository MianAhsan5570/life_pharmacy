...
<form class="form-horizontal" method="POST" action="php_action/edit_purchase.php" >
			  ...
			  <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Client Name" autocomplete="off"  value="<?=$data[2]?>" autofocus="true" />
			   </div>   
			  ...
			  <table class="table" id="productTable">
			  	...
			  	<tbody>
			  		...
			  		while($orderItemData = $orderItemResult->fetch_array()) { 
			  			...
			  			$fetchProductData = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM product WHERE product_id = '$orderItemData[product_id]'"));
			  			?>
