...
<div class="panel panel-default">
	...
	<div class="panel-heading">
		...
		<?php if($_GET['o'] == 'add') { ?>
  		...
  		<a href='orders.php?o=manord' style="color: white !important; " ><button class='btn btn-info pull pull-right' style="margin-top: -7px;"> 
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			    			<div class="input-group">
			    				<select class="form-control" id="clientName" name="clientName"  required style="z-index: 1">
 ...
 -->
			  ...
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Customer Phone</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" autofocus="true" id="clientContact" name="clientContact" placeholder="Contact Number" autocomplete="off" value="_" />
			    </div>
			  </div> <!--/form-group-->			  
		...
		var app = new Vue({
		  ...
		  mounted: function () {
		    ...
		    self.scanner.addListener('scan', function (content, image) {
		     ...
		     $("#scan_img").css('display','block');
		     addRow();
		     $("#productName"+focus_i).val(content);
		     getProductData(focus_i);
		     console.log(focus_i);		     
		     setTimeout(function(){
					$("#scan_img").css('display','none');
				},2500);
				/*var dir = document.getElementById('dir').value;
				var url = document.getElementById('student_attendance_url');
				if (url.value!='') {
					console.log(dir+url.value);
					//window.location.href=dir+url.value;
					$.ajax({
						url:dir+url.value,
						data:{d:"std_card"},
						type:'get',
