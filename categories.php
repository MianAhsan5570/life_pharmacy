    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitCategoriesForm" action="php_action/createCategories.php" method="POST">
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="categoriesName" class="col-sm-4 control-label">Categories Qty: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-7">
				      <input type="text" class="form-control" id="categoriesqty" placeholder="Categories quanity" name="categoriesqty" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	
	        <div class="form-group">
		        	...
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-7">
					      <input type="text" class="form-control" id="editCategoriesName" placeholder="Categories Name" name="editCategoriesName" autocomplete="off">
					       <input type="hidden" class="form-control" id="editCategoriesidnnew" placeholder="Categories Name" name="editCategoriesidnnew" autocomplete="off">
					    </div>
		        </div> <!-- /form-group-->	
		        	<label for="editCategoriesName" class="col-sm-4 control-label">Categories Quantity: </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-7">
					      <input type="text" class="form-control" id="editCategoriesqty" placeholder="Categories Name" name="editCategoriesqty" autocomplete="off">
					    </div>
		        </div> <!-- /form-group-->	         	        
		        <div class="form-group">
