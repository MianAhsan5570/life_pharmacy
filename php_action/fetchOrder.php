...
$sql = "SELECT order_id, order_date, client_name, client_contact, payment_status FROM orders WHERE order_status = 1 ORDER BY order_id DESC LIMIT 20";
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    <li><a href="orders.php?o=editOrd&i='.$orderId.'" id="editOrderModalBtn"> <i class="glyphicon glyphicon-edit"></i> Edit</a></li>
	     ...
	     <li><a href="orders.php?o=editOrd&i='.$orderId.'&type=new" id="editOrderModalBtn"> <i class="glyphicon glyphicon-edit"></i> Edit As new</a></li>
