...
<div class="row">
	...
	<div class="col-sm-4 hidden">
			...
			<div class="panel panel-body">
				<form action="" method="post">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" autofocus="" id="email" name="productName" value="<?= @$pro_name ?>">
				  </div>
				   <div class="form-group">
				  ...
				  <div class="form-group">
				   ...
				   <div class="form-group">
				    <label for="pwd">Category</label>
				   	...
				   	<select class="form-control" autocomplete="off" required id="editCategoryName" name="categoryName">
      ...
      <input type="radio"  <?=@($product_type=="0")?"checked":""?> value="0" name="product_type" checked>Product
    </label>
    <label class="radio-inline">
      <input type="radio" <?=@($product_type=="1")?"checked":""?> value="1" name="product_type">Deal
    </label>
				  </div>
				<?php
					if (isset($_GET['i'])) {
	...
	<tbody>
		...
		<tr>
			...
			<td contenteditable='false'><a href="addproduct.php?i=<?=$r['product_id'];?>"> <button class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span>Edit</button></a>
<?php if ($r['deal']==1): ?>
				
			
				<a href="deals.php?pro_id=<?=$r['product_id'];?>" target="_blank"> <button class="btn btn-warning"><span class="glyphicon glyphicon-plus"></span>Add Incre</button></a>
				<?php endif ?>
			</td>
