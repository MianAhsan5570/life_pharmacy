...
<div class="panel panel-success">
			  ...
			  <!-- <button type="button" class="btn btn-primary pull-right" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> Add Row </button> -->
			  		...
			  		for($x = 1; $x < 2; $x++) { ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="margin-left:20px;">
			  					...
			  					<select class="form-control livesearch" autocomplete="off"  onfocus="myFunction(this)"  name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)">
				...
				$fetchCategory = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM categories WHERE categories_id='$fetchProduct[categories_id]'"));
			  				...
			  				<td>
			  					...
			  					<input type="text" name="pack[]" id="pack<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control"  />
			  					<div class="input-group">
			  						
    <span class="input-group-addon">X</span>
   <input type="text" name="pac_quantity[]" id="pac_quantity<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control"  />
  </div>
			  				</td>
   ...
   <input type="text" name="totalpercentage[]" id="totalpercentage<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)"  autocomplete="off" class="form-control"  />
			  				...
			  				<td >
			  					...
			  					<input type="text" name="purchase_box[]" id="purchase_box<?php echo $x; ?>" autocomplete="off"  class="form-control" onkeyup="getTotal(<?php echo $x ?>)" />
			  					<div class="input-group">
			  						<span class="input-group-addon">PR</span>
			  					<input type="text" name="rate[]" id="purchase<?php echo $x; ?>" autocomplete="off"  class="form-control" readonly /></div>
			  					
			  					</div>
			  				</td>
			  				<td style="">
			  					<div class="form-group">
			  					<input type="text" name="rate1[]" id="rate1<?php echo $x; ?>" autocomplete="off"  class="form-control" readonly  />
			  					
			  					</div>
			  				</td> 
			  				<td style="">
			  					<div class="form-group">
			  					<input type="text" name="alert[]" id="alert<?php echo $x; ?>" autocomplete="off"  class="form-control"  />
			  				...
			  				<td style="">
			  					<div class="form-group">
			  					<input type="date" name="expiry[]" id="expiry<?php echo $x; ?>" 
			  					  class="form-control"  
